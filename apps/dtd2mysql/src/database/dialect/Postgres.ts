...
/**
 * Dates and timestamps are read back as the strings they were stored as, not as Date objects built in
 * the reader's timezone: the pool's type parsers see to that, see getPostgresPool in the container.
 */
