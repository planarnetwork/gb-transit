...
- 85add7a: `CSVParser` takes a `strict` option that throws on a row with more or fewer fields than the header,
...
- 8020652: Give the trip a coupling makes a route, a headcode, a headsign and a shape.
